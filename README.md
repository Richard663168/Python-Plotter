[README_Python_Plotter.md](https://github.com/user-attachments/files/31391545/README_Python_Plotter.md)
# Python Plotter

Python Plotter is a browser-based plotting and data-processing tool developed by **Richard Li** for spectroscopy, LED/device characterization, polarization-resolved measurements, electrochemistry, and time-resolved photoluminescence. The project was originally developed as **PYRL** (Python Plotter — Richard Li).
